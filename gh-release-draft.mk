...
@prefix@GH_ISSUES_JSON := $(@prefix@WORK)/github-issues.json
...
##
@prefix@GH_RELEASE_BODY := $(@prefix@WORK)/github-release.md
...
##
@prefix@GH_RELEASE_JSON := $(@prefix@WORK)/github-release.json
...
$(@prefix@GH_RELEASE_BODY): $(@prefix@GH_ISSUES_JSON)
	...
	$(call gh_issues,enhancement) >> $(@prefix@GH_RELEASE_BODY) 
	echo '' >> $(@prefix@GH_RELEASE_BODY)
	echo '## Bug Fixes' >> $(@prefix@GH_RELEASE_BODY)
	echo '' >> $(@prefix@GH_RELEASE_BODY)
	$(call gh_issues,bug) >> $(@prefix@GH_RELEASE_BODY) 
	echo '' >> $(@prefix@GH_RELEASE_BODY)
	echo '## Documentation' >> $(@prefix@GH_RELEASE_BODY)
	echo '' >> $(@prefix@GH_RELEASE_BODY)
	$(call gh_issues,documentation) >> $(@prefix@GH_RELEASE_BODY) 
